# CVMaker - Contribution Guide

## How to Contribute

1. **Fork the Repository**
   - Fork the cvmaker repository to your GitHub account.
...
- Follow the coding standards of the language you're contributing to (TypeScript, etc.).
...
By contributing to cvmaker, you agree that your contributions will be licensed under the Apache License 2.0. Make sure you're familiar with the terms of this license.
